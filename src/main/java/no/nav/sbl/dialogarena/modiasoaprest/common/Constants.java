...
public class Constants {
    ...
    public static final String MODIASOAPRESTPROXY_SYSTEM_USER = getFasitProperty("srvmodia-soap-til-rest-proxy_username");
    public static final String MODIASOAPRESTPROXY_SYSTEM_USER_PASSWORD = getFasitProperty("srvmodia-soap-til-rest-proxy_password");
