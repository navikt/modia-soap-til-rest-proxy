...
public class Constants {
    ...
    public static final String MODIASOAPRESTPROXY_SYSTEM_USER = EnvironmentUtils.getRequiredProperty(SERVICEUSER_USERNAME_PROPERTYNAME);
    public static final String MODIASOAPRESTPROXY_SYSTEM_USER_PASSWORD = EnvironmentUtils.getRequiredProperty(SERVICEUSER_PASSWORD_PROPERTYNAME);
